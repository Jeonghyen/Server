...
public class DAO {
	...
	//AddOk 서블릿이 입력받은 데이터(dto)를 insert하라
	public int add(DTO dto) {
		
		try {
			
			String sql ="insert into tblMemo(seq, subject, content, name, pw, regdate) \r\n"
	...
	//Edit서블릿이 메모 번호를 줄테니 레코드 전체를 주세요
